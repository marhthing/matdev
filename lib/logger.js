    ...
    getLogger() {
        const loggerInstance = {
            ...
            child: (context) => {
                ...
                // For now, we'll just return the same logger instance
                // You could enhance this to include context in log messages
