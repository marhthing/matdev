                ...
                if (editedContent) {
                    ...
                    if (!contextInfo) {
                        ...
                        if (messageKey && this.database) {
                            const archivedMessage = this.database.getMessageById(messageKey);
                            if (archivedMessage && archivedMessage.contextInfo) {
                                contextInfo = archivedMessage.contextInfo;
                    ...
                    if (contextInfo) {
                        ...
                        // For edited messages without contextInfo, preserve the original structure but add conversation
                        processedMessage = {
                            ...message.message,
