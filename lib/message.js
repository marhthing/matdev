                ...
                if (editedContent) {
                    ...
                    if (!contextInfo) {
                        ...
                        if (messageKey && this.database) {
                            ...
                            // Second try: Look for recent messages in the same chat with contextInfo
                            if (!contextInfo) {
                                console.log('🔍 Searching recent messages for contextInfo patterns...');
                                try {
                                    ...
                                    console.log('⚠️ Error searching recent messages:', error.message);
                                }
                            }
                        }
