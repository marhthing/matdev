...
class JSONStorageManager {
    ...
    async archiveMessage(message) {
        try {
            ...
            // Extract and store contextInfo for future reference (especially for edited messages)
            ...
            try {
                ...
                for (const msgType of messageTypes) {
                    ...
                    if (msgContent?.contextInfo) {
                        ...
                        this.logger.debug(`💾 Stored contextInfo from ${msgType} for future reference`);
                        break;
                    }
                }
            } catch (error) {
