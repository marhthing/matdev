...
class HuggingFacePlugin {
    constructor() {
        ...
        this.apiUrl = 'https://api-inference.huggingface.co/models/black-forest-labs/FLUX.1-dev';
    }
    ...
    registerCommands() {
        ...
        this.bot.messageHandler.registerCommand('ttm', this.textToImageCommand.bind(this), {
            description: 'Generate image from text using FLUX.1-dev',
    ...
    async textToImageCommand(messageInfo) {
        try {
            ...
            const processingMsg = await this.bot.messageHandler.reply(messageInfo, '🎨 Generating image with FLUX.1-dev...');
