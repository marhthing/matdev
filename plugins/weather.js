...
class WeatherPlugin {
    ...
    async getWeatherData(location) {
        try {
            // Check if the location is a country abbreviation and map it
            const mappedLocation = this.mapCountryAbbreviation(location);
    ...
    /**
     * Map country abbreviations to full country names
     */
    mapCountryAbbreviation(location) {
        const lowercaseLocation = location.toLowerCase().trim();
        
        // Check if it's a country abbreviation
        if (this.countryMapping[lowercaseLocation]) {
            return this.countryMapping[lowercaseLocation];
        }
